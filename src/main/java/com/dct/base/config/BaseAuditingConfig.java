...
public class BaseAuditingConfig {

    private static final Logger log = LoggerFactory.getLogger(BaseAuditingConfig.class);
    private static final String ENTITY_NAME = "BaseAuditingConfig";
